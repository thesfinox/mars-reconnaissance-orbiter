...
This module provides unit tests and non-regression tests for all functionality of the HSIMars hyperspectral image processing class. Tests are organized into logical groups and use descriptive names to clearly communicate their purpose.

All tests use stub/mock data generated by fixtures in conftest.py, ensuring fast, isolated, and reproducible testing without requiring real CRISM data files.
